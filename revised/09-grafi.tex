...
\begin{figure}[H]\centering
	...
	\caption{Cammino in un grafo diretto, \(a, b, c, e, d\) è un cammino di lunghezza \(4\)}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{\(a, b, c, e, d, a\) è un cammino del grafo di lunghezza \(5\)}
\end{figure}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Esampio di grafo aciclico e ciclico.}
\end{figure}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\hfill\null
	\caption{\((a)\) e \((b)\) sono componenti connesse massimali, \((c, d, e, f)\) è una componente fortemente connessa.}
\end{figure}
...
\subsubsection{L'algoritmo di Kosaraju}
