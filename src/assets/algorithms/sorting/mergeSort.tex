...
\prototype{\mergeSort{\Item{} \(A\), \Int \(first\), \Int \(last\)}}{

	\BlankLine
	\If(\Comment*[h]{devono esistere almeno due elementi}){\(first < last\)}{

		\BlankLine
		\Int \(mid \Assign \floor*{\frac{first + last}{2}}\)\;
		...
		\BlankLine
		\merge{\(A\), \(first\), \(last\), \(mid\)}\Comment*[l]{unisce le soluzioni}
	}
}
