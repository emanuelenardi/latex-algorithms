...
\prototype{\ccdfs{\Graph G, \Int counter, \Node u, \Array{\Int} id}}{
	\params{ccdfs}{counter}[identificatore di quante cc ho trovato fin'ora]
	\params{ccdfs}{u}[il nodo che sto visitando]
	\params{ccdfs}{id}[l'identificativo della componente]
