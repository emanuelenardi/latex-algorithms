...
\prototype{\Bool \hasCycleRec{\Graph \(G\), \Node \(u\), \Node \(p\), \Array{\Bool} \(visited\)}}{
	\params{hasCycleRec}{G}[grafo esplorato]
	\params{hasCycleRec}{u}[nodo da esaminare]
	\params{hasCycleRec}{p}[nodo da cui provengo (padre)]
	\params{hasCycleRec}{visited}[vettore dei nodi visitati]
