...
\begin{itemize}
	...
	\item \(2^n \neq \Theta(3^n)\), ovviamente \(2^n = \Omicron(3^n)\), ma \(3^n = \left(\frac{3}{2} \cdot 2\right)^n = \left(\frac{3}{2}\right)^n \cdot 2^n\).
...
\begin{note}
L'equazione di riccorrenza rappresenta il caso in cui \selectionSort sia espresso in forma ricorsiva.
\end{note}
\begin{figure}[H]
	\centering
...
\begin{itemize}
	...
	Possiamo notare che \textbf{l'ultima disequazione risulta impossibile}.
...
\begin{itemize}
	...
	T(n) &= 2T(\floor*{ \frac{n}{2} }) + n \Arrow{sost. ip. ind. con \(k = \floor*{\frac{n}{2}}\)}\\
		 ...
		 &\leqslant 2c \frac{n}{2} \log \frac{n}{2} + n \Arrow{semplifico il \(2\)}\\
