...
Ad esempio se prendiamo in considerazione la stringa \(T =\) \texttt{"ABDCCAABD"}, il prefisso composto dai primi \(3\) caratteri è \(T(3) =\) "ABD", il prefisso composto dai primi \(6\) caratteri è \(T(6) =\) \texttt{"ABDCCA"}.
Infine il prefisso composto dai primi \(0\) caratteri è \(T(0) =\) "", ossia la stringa vuota.
