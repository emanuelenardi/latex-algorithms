...
\end{enumerate*}
, ripetendo le azioni precedenti fino a quando non è più possibile trovare un flusso positivo \(g\).
...
Per fare la dimostrazione di correttezza dobbiamo (re)introdurre delle definizioni.% chktex 36
