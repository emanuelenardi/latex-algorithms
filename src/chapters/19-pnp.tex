...
\subsubsection{Se \texorpdfstring{\(S \subseteq V\)}{S sottoinsieme di V} è un insieme indipendente, allora \texorpdfstring{\(V - S\)}{V - S} è una copertura di vertici}% chktex 8
...
\subsubsection{Se \texorpdfstring{\(V - S\)}{V - S} è una copertura di vertici, allora \texorpdfstring{\(S \subseteq V\)}{S sottoinsieme di V} è un insieme indipendente}% chktex 8
