...
\begin{table}[H]
	...
	\begin{tabular}{@{} l *{3}{c} @{}}
	\toprule
		\textbf{Struttura dati} & \dictLookup & \dictInsert & \dictRemove\\
	\midrule
...
Per passare da successore a predecessore \emph{right} diventa \emph{left} e \minFunction diventa \maxFunction.
...
Per inserire un nodo in un albero Red-Black si usa la stessa procedura usata per gli alberi binari di ricerca e si colora il nuovo nodo di \RED.% chktex 8
