...
\]
Partiamo da una soluzione semplice ma ingenua (na\"if), che deriva dalla definizione del problema.
...
\begin{algorithm}[H]
\caption{Implementazione na\"if della ricerca del minimo}\label{alg:ricerca-minimo-banale}
