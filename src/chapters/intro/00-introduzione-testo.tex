\phantomsection
\addcontentsline{toc}{chapter}{Introduzione al testo}
\chapter*{Introduzione al testo\markboth{Introduzione al testo}{}}
...
Se trovi errori di qualsiasi natura non indugiare a segnalarmeli, li correggerò il prima possibile e aggiornerò l'errata corrige, inoltre verrai menzionato vicino all'errore segnalato.
...
Ho raccolto varie risorse per visualizzare gli algoritmi attraverso l'animazione: \href{https://visualgo.net/en}{VisuAlgo \ExternalLink}, \href{https://algorithm-visualizer.org/}{Algoritm Visualizer \ExternalLink}, \href{https://www.cs.usfca.edu/~galles/visualization/Algorithms.html}{Data Structure Visualizations \ExternalLink}, \href{https://www.hackerearth.com/practice/algorithms/}{hackerearth \ExternalLink}.
Per gli amanti dell'arte generativa visitare \href{http://sorting.at/}{sorting.at \ExternalLink} e \href{https://imgur.com/gallery/GD5gi}{Sorting Algorithms Revisualized on Imgur \ExternalLink}.
...
Come ultima battuta vorrei ringraziare tutti coloro che mi hanno sostenuto in questi mesi per la stesura di questo testo e a coloro senza i quali sarebbero rimasti dei semplici appunti.
