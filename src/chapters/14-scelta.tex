...
\begin{table}[H]\centering
\caption{Quale complessità preferire?}\label{tab:complexity-shortestPath-singleSource-compared}
...
\begin{table}[!ht]
\caption{Quale complessità preferire?}\label{tab:complexity-shortestPath-multipleSource-compared}
