...
\begin{table}[H]
	\centering
	\caption{Implementazione delle strutture dati nei vari linguaggi,\\nota che Java distingue chiaramente la specifica dall'implementazione}
...
\medskip
Ogni volta che si fa una chiamata a funzione si usa implicitamente una pila, in quanto memorizza tutti i record di attivazione delle chiamate effettuate.
