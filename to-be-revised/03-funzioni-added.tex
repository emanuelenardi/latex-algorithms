...
% NOTE ricordati di utilizzare il flag '--shell-escape' o 'shell: yes' con arara
...
Date le nostre nuove conoscenze possiamo calcolare con precisione la complessità delle varie versioni degli algoritmi proposti per la soluzione al problema\dots.

\subsection*{Complessità della prima versione}
...
\subsection*{Complessità della versione 2}
...
\subsection*{Complessità della versione 3}
...
\subsection*{Complessità della versione 4}
