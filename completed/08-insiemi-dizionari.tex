...
\subsection{Realizzazione con vettori booleani}
...
\includestandalone{assets/algorithms/08/set-vectorBool-pseudocode}

\subsubsection{Implementazioni nei linguaggi}
...
\subsection{Realizzazione con vettore non ordinato}

\includestandalone{assets/algorithms/08/set-unorderedVector-pseudocode}
...
\subsection{Realizzazione vettore ordinato}

\includestandalone{assets/algorithms/08/set-orderedVector-pseudocode}
...
\begin{table}[h]
	\centering
	\caption{Implementazioni e relative complessità delle operazioni\\\(m \equiv\) dimensione del vettore o della tabella hash}%
