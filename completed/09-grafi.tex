...
\begin{itemize}
	\item Ricerca del cammino più breve, misurato in numero di archi, che differisce dal problema del cammino minimo che cerca di stabilire quale sia il cammino meno costoso;
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}\centering
		% \includegraphics{assets/figures/09/definition-directed}
		\includegraphics{assets/figures/09/rev-graph-directed}
		\caption{Grafo diretto}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}\centering
		% \includegraphics{assets/figures/09/definition-undirected}
		\includegraphics{assets/figures/09/rev-graph-undirected}
...
\begin{multicols}{2}
\centering
% \includegraphics{assets/figures/09/adjacent}
\includegraphics{assets/figures/09/rev-graph-directed-adj}
\columnbreak
\begin{itemize}
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics{assets/figures/09/rev-graph-undirected-sparse}
		\caption{Grafo sparso}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics{assets/figures/09/rev-graph-undirected-dense}
		\caption{Grafo denso}
	\end{subfigure}
\end{figure}
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics[page=1]{assets/figures/09/rev-forest}
		\caption{Albero libero}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics[page=2]{assets/figures/09/rev-forest}
...
\begin{figure}[H]
	\begin{subfigure}[t]{.5\textwidth}\centering
		\includegraphics{assets/figures/09/rev-graph-undirected-degree}
		\caption{Grado di un grafo indiretto}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.5\textwidth}\centering
		\includegraphics{assets/figures/09/rev-graph-directed-degree}
		\caption{Grado un grafo diretto}
	\end{subfigure}
\end{figure}
...
\begin{figure}[H]\centering
	\includegraphics{assets/figures/09/rev-graph-directed-path}
...
In quella che utilizzeremo non utilizza la rimozione dei nodi dal grafo.

\begin{algorithm}[H]
	\caption{Specifica della struttura dati \textsc{Graph}}
	\input{assets/algorithms/09/graph-interface}
\end{algorithm}
...
\begin{figure}[h]\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/rev-memory-graph-directed}
		\caption{Grafo orientato}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/rev-memory-graph-directed}
		\caption{Matrice di adiacenza}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.35\textwidth}\raggedright
		\includegraphics[width=\linewidth, height=3.5cm, keepaspectratio, page=3]{assets/figures/09/rev-memory-graph-directed}
...
\begin{figure}[h]\hfill
	...
	\begin{subfigure}[t]{.3\textwidth}\raggedright
		\includegraphics[width=\linewidth, height=4cm, keepaspectratio, page=3]{assets/figures/09/rev-memory-graph-directed}
		\caption{Lista di adiacenza}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.20\textwidth}\raggedright
		\includegraphics[width=\linewidth, height=4cm, keepaspectratio, page=4]{assets/figures/09/rev-memory-graph-directed}
...
\begin{figure}[h]\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/rev-memory-graph-undirected}
		\caption{Grafo non orientato}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/rev-memory-graph-undirected}
		\caption{Matrice di adiacenza}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.35\textwidth}\raggedright
		\includegraphics[width=\linewidth, height=3.5cm, keepaspectratio, page=3]{assets/figures/09/rev-memory-graph-undirected}
		\caption{Lista di adiacenza}
	\end{subfigure}
\end{figure}
...
Mentre se lo memorizziamo come lista di adiacenza memorizziamo il peso.

\begin{figure}[h]\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/rev-memory-graph-weighted}
		\caption{Grafo pesato}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.25\textwidth}\centering
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/rev-memory-graph-weighted}
		\caption{Matrice di adiacenza}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.35\textwidth}\raggedright
		\includegraphics[width=\linewidth, height=3.5cm, keepaspectratio, page=3]{assets/figures/09/rev-memory-graph-weighted}
		\caption{Lista di adiacenza}
	\end{subfigure}
\end{figure}
...
Le matrici sono ideali per grafi \emph{densi}, occupano uno spazio \(\Omicron(n^2)\) ed iterare su tutti gli archi costa \(\Omicron(n^2)\), verificare se \(u\) è adiacente a \(v\) richiede tempo costante \(\Omicron(1)\).

\medskip
Le liste di adiacenza sono ideali per grafi \emph{sparsi}, occupa uno spazio \(\Omicron(n+m)\) ed iterare su tutti gli archi costa \(\Omicron(n+m)\), verificare se \(u\) è adiacente a \(v\) richiede tempo lineare \(\Omicron(n)\).
...
La visita in profondità effettua una visita ricorsiva: per ogni nodo adiacente, si visita il nodo e tutti i suoi adiacenti ricorsivamente.
Due possibili applicazioni sono l'ordinamento topologico, la verifica della ciclicità e le componenti connesse e fortemente connesse.
...
\input{assets/algorithms/09/visita-albero}
\end{algorithm}
...
\begin{figure}[H]
	...
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/errata}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/errata}
	\end{subfigure}

	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/errata}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/errata}
	\end{subfigure}

	\caption{Esempio di attraversamento di un grafo\\tramite la procedura di visita di un albero}
\end{figure}

Dall'esempio possiamo notare come i nodi vengano reinseriti all'infinito all'interno della cosa e questo non permette all'algoritmo di terminare.
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/visita-grafo}
\end{algorithm}
...
\begin{itemize}
	...
	\item calcolare il cammino più breve da \(r\) a tutti gli altri nodi, dove il cammino più breve come il percorso con il minor numero di archi;
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/bfs-proc}
\end{algorithm}
...
\medskip
Paulo Erd\"{o}s era uno dei matematici più prolifico al mondo (1500+ articoli e 500+ co-autori).
...
\begin{itemize}
	...
	\item Se \(X\) p co-autore di qualcuno con \(erdos = k\) e non è co-autore con qualcuno con \(erdos < k\), allora \(X\) ha \(erdos = k+1\);
	\item Le persone non raggiunte da questa definizione hanno \(erdos = +\infty\).
\end{itemize}

\begin{algorithm}[ht]
	\caption{Visita in ampiezza (erdos)}
	\input{assets/algorithms/09/erdos}
\end{algorithm}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/erd-rev}
		\caption{Assegno al nodo \(a\) distanza \(0\), lo aggiungo alla coda}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/erd-rev}
	...
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/erd-rev}
		\caption{Estraggo il nodo \(c\),
			assegno ai suoi nodi adiacenti non ancora visitati (\(b\), \(d\)) distanza \(c+1 = 2\)
			e li aggiungo alla coda}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/erd-rev}
	...
	\begin{subfigure}[t]{.45\textwidth}
		...
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/erd-rev}
		\caption{Estraggo il nodo \(f\),
			assegno ai suoi nodi adiacenti non ancora visitati (\(b\), \(g\)) distanza \(f+1 = 2\)\\
			e li aggiungo alla coda}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=6]{assets/figures/09/erd-rev}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.45\textwidth}
		...
		\includegraphics[width=\linewidth, page=7]{assets/figures/09/erd-rev}
		\caption{Estraggo il nodo \(d\),
			il quale non ha nodi adiacenti non ancora visitati}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=8]{assets/figures/09/erd-rev}
	...
	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=9]{assets/figures/09/erd-rev}
		\caption{Estraggo il nodo \(g\),
			il quale non ha nodi adiacenti non ancora visitati}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=10]{assets/figures/09/erd-rev}
		\caption{Estraggo il nodo \(j\),
			il quale non ha nodi adiacenti non ancora visitati}
	\end{subfigure}

	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=11]{assets/figures/09/erd-rev}
		\caption{Questo è l'albero risultante}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.45\textwidth}
		\includegraphics[width=\linewidth, page=12]{assets/figures/09/erd-rev}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/printPath}
\end{algorithm}
...
Molto spesso la visita in profondità è solo una parte di una soluzione ad un altro problema, viene utlizzata per esplorare un intero grafo, e non solo i nodi raggiungibili da una singola sorgente.

\medskip
L'output dell'algoritmo non è più un singolo albero, ma una foresta depth-first (ossia un insieme di alberi depth-first).

\medskip
La struttura dati utilizzata non è più una cosa, ma bensì una stack implicito (attraverso la ricorsione) o esplicito (vedremo un algortimo).

\begin{algorithm}[H]
	\caption{Visita in profondità, ricorsiva con stack implicito}
	\input{assets/algorithms/09/dfs-stack-implicit}
\end{algorithm}
...
\begin{algorithm}[h]
	...
	\input{assets/algorithms/09/dfs-stack-explicit}
\end{algorithm}

La procedura si ottiene semplicemente sostituendo una pila alla coda utilizzata nella visita \breadthFirstSearch.

Un nodo può essere inserito nella pila più volte (tanti quanti sono gli archi entranti in quel nodo, gli archi entranti in tutti i nodi è limitato superiormente dal numero di archi \(m\), quindi \(\Omicron(m)\)), in quanto il controllo se un nodo è già stato inserito viene fatto all'estrazione, non all'inserimento come avveniva in precedenza.

\paragraph{Complessità della visita in ampiezza con stack esplicito}
Inserimenti ed estrazioni sono pari al numero degli archi, quindi \(\Omicron(m)\), visitare gli archi costa \(\Omicron(m)\) e le visite dei nodi costano \(\Omicron(n)\), per una complessità risultante di \(\Omicron(m+n)\).
...
Non vedremo il codice poiché è complicato e i dettagli non sono interessanti, quindi viene sono accennato.

\subsubsection{Componenti connesse}

Vogliamo identificare le componenti connesse di un grafo.
Prima di tutto voglia capire se è connesso, dopodiché sapere quante sono le sue componenti connesse.
...
\begin{itemize}
	\item Componenti Connesse (\foreign{Connected Components, CC}), definite su grafi \emph{non orientati};
	\item Componenti fortemente Connesse (\foreign{Strongly Connected Components, SCC}), definite su grafi \emph{non orientati}
\end{itemize}
...
Per farlo faremo utilizzo di un vettore (che chiamere \(id\)), il quale conterrà l'indentificatore alla quale la componente appartiene (\(id[u]\) è l'indentificatore della c.c. a cui appartiene \(u\)).
...
\begin{algorithm}[h]
	...
	\input{assets/algorithms/09/cc}
	\input{assets/algorithms/09/cc-dfs}
\end{algorithm}
...
\begin{figure}[p]
	...
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/ccex-anim-rev}
		\caption{Stato iniziale}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/ccex-anim-rev}
		\caption{Partiamo dal nodo \(a\) per comodità,
			gli assegniamo il valore \(1\)}
	\end{subfigure}

	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=7]{assets/figures/09/ccex-anim-rev}
		\caption{Visito tutti i nodi adiacenti al nodo \(a\)}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=11]{assets/figures/09/ccex-anim-rev}
		\caption{Una volta arrivati al nodo \(d\) abbiamo già visitato tutti i suoi possibili vicini}
	\end{subfigure}

	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=16]{assets/figures/09/ccex-anim-rev}
		\caption{Abbiamo completato la visita della prima componente connessa}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=17]{assets/figures/09/ccex-anim-rev}
	...
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=34]{assets/figures/09/ccex-anim-rev}
		\caption{Completo così anche la seconda componente\dots}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.48\textwidth}
		\includegraphics[width=\linewidth, page=35]{assets/figures/09/ccex-anim-rev}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.3\textwidth]{assets/figures/09/ciclo-non-rev}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.3\textwidth]{assets/figures/09/acyclic-und-rev}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/hasCycleRec}
	\input{assets/algorithms/09/hasCycle}
\end{algorithm}
...
La definizione è identica a meno del fatto che consideriamo cicli anche quelli composti da due nodi (\(k \geqslant 2\))

\begin{figure}[H]
	\centering
	\includegraphics{assets/figures/09/ciclo-rev}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{.5\textwidth}
		\includegraphics[page=1]{assets/figures/09/acyclic-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[page=2]{assets/figures/09/acyclic-rev}
	\end{subfigure}
	\caption{}
\end{figure}

I \foreign{Directed Acyclic Graph}, DAG d'ora in poi rappresentano una classe di problemi ben precisi vedremo degli algoritmi specifici.
...
\begin{figure}[H]
	...
	\begin{subfigure}{.18\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/acyclic-error-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.18\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/acyclic-error-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.18\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/acyclic-error-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.18\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/acyclic-error-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.18\textwidth}
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/acyclic-error-rev}
	\end{subfigure}
	\caption{Se in un grafo esistono due cammini che mi portano allo stesso nodo l'algoritmo precedente mi dirà erroneamente che esiste un ciclo.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics[page=1]{assets/figures/09/schema-rev}
		% \caption{}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}\centering
		\includegraphics[page=2]{assets/figures/09/schema-rev}
		% \caption{}
	\end{subfigure}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/dfs-schema}
\end{algorithm}
...
\begin{figure}[H]
	...
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=6]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}

	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=7]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=8]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=9]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=10]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=11]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=12]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}

	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=13]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=14]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=15]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=16]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=17]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=18]{assets/figures/09/schema-esempio-rev}
	\end{subfigure}

	\caption{Visitati in ordine alfabetico per comodità}
\end{figure}

% TODO disegnare uno schema
...
Possiamo dimostrare delle proprietà sul tipo di archi e usarle per costruire algoritmi migliori.
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/hasCycleDAG}
\end{algorithm}

\begin{figure}[H]

	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}

	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=6]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=7]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=8]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=9]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.20\textwidth}
		\includegraphics[width=\linewidth, page=10]{assets/figures/09/acyclic-schema-rev}
	\end{subfigure}

	\caption{Questo è il particolare grafo sulla quale possiamo testare la nostra funzione}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{assets/figures/09/top-sort1}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/topSort}
	\input{assets/algorithms/09/topSort-dfs}
\end{algorithm}
...
\begin{figure}[H]
	...
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=6]{assets/figures/09/topsort-rev}
	\end{subfigure}

	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=7]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=8]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=9]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=10]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=11]{assets/figures/09/topsort-rev}
	\end{subfigure}\hfill
	\begin{subfigure}{.15\textwidth}
		\includegraphics[width=\linewidth, page=12]{assets/figures/09/topsort-rev}
	\end{subfigure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/scc}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/scc}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/scc}
	\end{subfigure}\hfill
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/scc}
	\end{subfigure}\hfill
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=\linewidth, page=5]{assets/figures/09/scc}
	\end{subfigure}
...
\begin{enumerate*}
	...
	\item esegue una visita in profondità sul grafo trasposto \(G^T\) utilizzando l'algorithm \ConnectedComponents, esaminando i nodi nell'ordine inverso di tempo di fine della prima visita;
\end{enumerate*}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/scc}
\end{algorithm}
...
Dato un grafo orientato \(G = (V, E)\), il grafo trasposto \(G_t = (V,E_T)\) ha gli stessi nodi e gli archi orientati in senso opposto: \(E_T = \{ (u,v) \mid (v,u) \in E \}\)
\end{definition}

\begin{algorithm}[H]
	\caption{Calcolo del grafo trasposto}
	\input{assets/algorithms/09/transpose}
\end{algorithm}

\paragraph{Complessità}
Il costo computazionale totale costa \(\Omicron(m+n)\), in quanto aggiungere i nodi costa \(\Omicron(n)\), gli archi \(\Omicron(m)\) ed ogni operazione costa \(\Omicron(1)\).

\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=2]{assets/figures/09/scc3}
		\caption{Grafo originale}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/scc3}
...
\begin{algorithm}[H]
	...
	\input{assets/algorithms/09/cc-alt}
	\input{assets/algorithms/09/cc-dfs}
\end{algorithm}
...
\begin{figure}[H]\centering
	\includegraphics[page=4]{assets/figures/09/scc3}
...
\begin{figure}[H]\centering
	\begin{subfigure}[t]{.3\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/scc4}
		\caption{La prima visita parte da \(f\),\\la seconda dal nodo \(a\)}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.3\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/scc4}
		\caption{Calcolo il grafo trasposto \(G^T\)}
	\end{subfigure}\hfill
	\begin{subfigure}[t]{.3\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/scc4}
		\caption{Identificazione delle componenti fortemente connesse}
	\end{subfigure}
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=1]{assets/figures/09/scc2}
		\caption{Grafo delle componenti del grafo}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=6]{assets/figures/09/scc2}
...
Possiamo definirci quindi \(dt(C) = \minFunction\{dt(u) \mid u \in C\}\) e \(ft(C) = \maxFunction\{ft(u) \mid u \in C\}\), i quali corrisponderanno ai tempo di inizio e di fine del primo nodo visitato in \(C\).

\begin{theorem}
Siano \(C\) e \(C'\) due distinte componenti fortemente connesse nel grafo orientato \(G = (V,E)\).
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=3]{assets/figures/09/scc2}
		\caption{Grafo delle componenti del grafo}
	\end{subfigure}\hfill
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=\linewidth, page=4]{assets/figures/09/scc2}
		\caption{Grafo delle componenti del grafo trasposto}
	\end{subfigure}
\end{figure}
...
L'algoritmo di Tarjan è preferito a quello di Korasaju il quale, avendo comunque la medesima complessità computazionale (\(\Omicron(m+n)\)), è preferito a quest'ultimo in quanto necessita di una sola visita e non richiede la trasposizione del grafo (al posto una doppia visita e di memoria aggiuntiva).
